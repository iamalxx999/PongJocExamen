# modulul turtle importat
import turtle


# crearea ecranului
sc = turtle.Screen()
sc.title("Pong Examen JOC")
sc.bgcolor("White")
...
# functia de miscare al rachetelor
def paddleaup():
	y = left_pad.ycor()
	y += 20
	left_pad.sety(y)
...
# tastele folosite pentru a misca rachetele
sc.listen()
...
while True:
	...
	# colusiunea intre mingea si racheta
